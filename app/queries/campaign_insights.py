...
def get_campaign_insights(campaign_id:int, page:int=1, size:int=10, ):
    ...
    FROM
        ...
        LEFT OUTER JOIN RECIPIENTS_MAPPING ON RECIPIENTS_MAPPING.EMAIL_ID = EMAILS.ID
        LEFT OUTER JOIN ATTACHMENT_MAPPING ON ATTACHMENT_MAPPING.EMAIL_ID = EMAILS.ID
